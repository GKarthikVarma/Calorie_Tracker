...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void insertUser(String username, String password)
    {
        ...
        db.delete(TABLE_USER_LIST,"username = ?",new String[] {username});
    ...
    {
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT username, name FROM " + TABLE_USER_DETAIL;
        Cursor cursor = db.rawQuery(query,null);
        String a,b;
        if(cursor.moveToFirst())
        {
    ...
    public void setpass(String username,String password)
    {
        ...
        values.put("username",username);
        values.put("password",password);
        db.insertWithOnConflict(TABLE_USER_LIST,null,values,SQLiteDatabase.CONFLICT_REPLACE);
        db.close();;
    }
